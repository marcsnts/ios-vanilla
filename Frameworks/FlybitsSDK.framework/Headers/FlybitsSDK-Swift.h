...
SWIFT_MODULE_NAMESPACE_PUSH("FlybitsSDK")
...
+ (FlybitsRequest * _Nullable)isConnectedWithCompletion:(void (^ _Nonnull)(BOOL, User * _Nullable, NSError * _Nullable))completion SWIFT_WARN_UNUSED_RESULT;
